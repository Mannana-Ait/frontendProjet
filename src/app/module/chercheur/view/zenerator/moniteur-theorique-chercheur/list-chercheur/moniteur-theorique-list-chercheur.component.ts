...
@Component({
    selector: 'app-moniteur-theorique-list-chercheur',
    templateUrl: './moniteur-theorique-list-chercheur.component.html',
    styleUrls: ['./moniteur-theorique-list-chercheur.component.css']
})
export class MoniteurTheoriqueListChercheurComponent implements OnInit {
    // declarations
