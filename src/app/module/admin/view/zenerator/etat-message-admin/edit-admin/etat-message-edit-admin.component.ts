...
@Component({
    selector: 'app-etat-message-edit-admin',
    templateUrl: './etat-message-edit-admin.component.html',
    styleUrls: ['./etat-message-edit-admin.component.css']
})
export class EtatMessageEditAdminComponent implements OnInit {
