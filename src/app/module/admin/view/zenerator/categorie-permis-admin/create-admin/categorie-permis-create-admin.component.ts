...
@Component({
    selector: 'app-categorie-permis-create-admin',
    templateUrl: './categorie-permis-create-admin.component.html',
    styleUrls: ['./categorie-permis-create-admin.component.css']
})
export class CategoriePermisCreateAdminComponent implements OnInit {
