...
@Component({
    selector: 'app-planning-item-edit-admin',
    templateUrl: './planning-item-edit-admin.component.html',
    styleUrls: ['./planning-item-edit-admin.component.css']
})
export class PlanningItemEditAdminComponent implements OnInit {
