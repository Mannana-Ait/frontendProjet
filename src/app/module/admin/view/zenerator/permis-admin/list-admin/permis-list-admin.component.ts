...
@Component({
    selector: 'app-permis-list-admin',
    templateUrl: './permis-list-admin.component.html',
    styleUrls: ['./permis-list-admin.component.css']
})
export class PermisListAdminComponent implements OnInit {
    // declarations
