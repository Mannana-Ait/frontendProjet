...
@Component({
    selector: 'app-moniteur-theorique-create-chercheur',
    templateUrl: './moniteur-theorique-create-chercheur.component.html',
    styleUrls: ['./moniteur-theorique-create-chercheur.component.css']
})
export class MoniteurTheoriqueCreateChercheurComponent implements OnInit {
