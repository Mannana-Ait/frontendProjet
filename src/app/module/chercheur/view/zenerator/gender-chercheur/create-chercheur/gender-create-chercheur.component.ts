...
@Component({
    selector: 'app-gender-create-chercheur',
    templateUrl: './gender-create-chercheur.component.html',
    styleUrls: ['./gender-create-chercheur.component.css']
})
export class GenderCreateChercheurComponent implements OnInit {
