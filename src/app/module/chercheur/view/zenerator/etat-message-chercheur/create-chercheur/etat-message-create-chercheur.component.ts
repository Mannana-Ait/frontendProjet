...
@Component({
    selector: 'app-etat-message-create-chercheur',
    templateUrl: './etat-message-create-chercheur.component.html',
    styleUrls: ['./etat-message-create-chercheur.component.css']
})
export class EtatMessageCreateChercheurComponent implements OnInit {
