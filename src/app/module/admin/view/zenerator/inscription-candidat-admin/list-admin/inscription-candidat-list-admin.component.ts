...
@Component({
  selector: 'app-inscription-candidat-list-admin',
  templateUrl: './inscription-candidat-list-admin.component.html',
  styleUrls: ['./inscription-candidat-list-admin.component.css']
})
export class InscriptionCandidatListAdminComponent implements OnInit {
   // declarations
