...
@Component({
    ...
    styleUrls: ['./message-list-admin.component.css']
})
export class MessageListAdminComponent implements OnInit {
    ...
    constructor(private datePipe: DatePipe, private messageService: MessageService, private confirmationService: ConfirmationService,
                ...
                private exportService: ExportService, private etatMessageService: EtatMessageService, private messagesService: MessagesService
    ) {
    }
