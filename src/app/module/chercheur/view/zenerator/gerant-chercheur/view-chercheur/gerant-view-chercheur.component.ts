...
@Component({
    selector: 'app-gerant-view-chercheur',
    templateUrl: './gerant-view-chercheur.component.html',
    styleUrls: ['./gerant-view-chercheur.component.css']
})
export class GerantViewChercheurComponent implements OnInit {
