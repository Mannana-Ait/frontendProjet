...
@Component({
    selector: 'app-type-avis-create-admin',
    templateUrl: './type-avis-create-admin.component.html',
    styleUrls: ['./type-avis-create-admin.component.css']
})
export class TypeAvisCreateAdminComponent implements OnInit {
