...
@Component({
    selector: 'app-gerant-list-admin',
    templateUrl: './gerant-list-admin.component.html',
    styleUrls: ['./gerant-list-admin.component.css']
})
export class GerantListAdminComponent implements OnInit {
    // declarations
