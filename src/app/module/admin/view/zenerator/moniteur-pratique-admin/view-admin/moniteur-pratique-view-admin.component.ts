...
@Component({
    selector: 'app-moniteur-pratique-view-admin',
    templateUrl: './moniteur-pratique-view-admin.component.html',
    styleUrls: ['./moniteur-pratique-view-admin.component.css']
})
export class MoniteurPratiqueViewAdminComponent implements OnInit {
