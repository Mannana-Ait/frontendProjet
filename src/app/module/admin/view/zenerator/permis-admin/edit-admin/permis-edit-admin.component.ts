...
@Component({
    selector: 'app-permis-edit-admin',
    templateUrl: './permis-edit-admin.component.html',
    styleUrls: ['./permis-edit-admin.component.css']
})
export class PermisEditAdminComponent implements OnInit {
