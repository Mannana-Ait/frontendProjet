...
@Component({
    selector: 'app-categorie-permis-list-admin',
    templateUrl: './categorie-permis-list-admin.component.html',
    styleUrls: ['./categorie-permis-list-admin.component.css']
})
export class CategoriePermisListAdminComponent implements OnInit {
    // declarations
