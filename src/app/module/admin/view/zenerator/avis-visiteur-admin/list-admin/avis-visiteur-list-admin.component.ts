...
@Component({
    selector: 'app-avis-visiteur-list-admin',
    templateUrl: './avis-visiteur-list-admin.component.html',
    styleUrls: ['./avis-visiteur-list-admin.component.css']
})
export class AvisVisiteurListAdminComponent implements OnInit {
    // declarations
