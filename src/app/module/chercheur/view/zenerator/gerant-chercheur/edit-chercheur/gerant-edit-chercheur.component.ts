...
@Component({
    selector: 'app-gerant-edit-chercheur',
    templateUrl: './gerant-edit-chercheur.component.html',
    styleUrls: ['./gerant-edit-chercheur.component.css']
})
export class GerantEditChercheurComponent implements OnInit {
