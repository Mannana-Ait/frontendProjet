...
@Component({
    selector: 'app-type-avis-list-admin',
    templateUrl: './type-avis-list-admin.component.html',
    styleUrls: ['./type-avis-list-admin.component.css']
})
export class TypeAvisListAdminComponent implements OnInit {
    // declarations
