...
@Component({
  selector: 'app-inscription-candidat-view-chercheur',
  templateUrl: './inscription-candidat-view-chercheur.component.html',
  styleUrls: ['./inscription-candidat-view-chercheur.component.css']
})
export class InscriptionCandidatViewChercheurComponent implements OnInit {
