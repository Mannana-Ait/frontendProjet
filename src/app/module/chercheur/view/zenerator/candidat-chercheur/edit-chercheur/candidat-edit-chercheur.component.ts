...
@Component({
  selector: 'app-candidat-edit-chercheur',
  templateUrl: './candidat-edit-chercheur.component.html',
  styleUrls: ['./candidat-edit-chercheur.component.css']
})
export class CandidatEditChercheurComponent implements OnInit {
