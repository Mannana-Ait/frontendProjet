...
@Component({
    selector: 'app-moniteur-pratique-create-admin',
    templateUrl: './moniteur-pratique-create-admin.component.html',
    styleUrls: ['./moniteur-pratique-create-admin.component.css']
})
export class MoniteurPratiqueCreateAdminComponent implements OnInit {
