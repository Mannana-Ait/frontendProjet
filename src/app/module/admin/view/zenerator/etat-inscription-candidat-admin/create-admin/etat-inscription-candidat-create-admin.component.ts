...
@Component({
  selector: 'app-etat-inscription-candidat-create-admin',
  templateUrl: './etat-inscription-candidat-create-admin.component.html',
  styleUrls: ['./etat-inscription-candidat-create-admin.component.css']
})
export class EtatInscriptionCandidatCreateAdminComponent implements OnInit {
