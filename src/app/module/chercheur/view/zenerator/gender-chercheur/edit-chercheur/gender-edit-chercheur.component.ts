...
@Component({
    selector: 'app-gender-edit-chercheur',
    templateUrl: './gender-edit-chercheur.component.html',
    styleUrls: ['./gender-edit-chercheur.component.css']
})
export class GenderEditChercheurComponent implements OnInit {
