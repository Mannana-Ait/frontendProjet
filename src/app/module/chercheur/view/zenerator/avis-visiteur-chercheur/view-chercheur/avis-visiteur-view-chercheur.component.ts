...
@Component({
    selector: 'app-avis-visiteur-view-chercheur',
    templateUrl: './avis-visiteur-view-chercheur.component.html',
    styleUrls: ['./avis-visiteur-view-chercheur.component.css']
})
export class AvisVisiteurViewChercheurComponent implements OnInit {
