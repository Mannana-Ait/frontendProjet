...
@Component({
    selector: 'app-permis-create-chercheur',
    templateUrl: './permis-create-chercheur.component.html',
    styleUrls: ['./permis-create-chercheur.component.css']
})
export class PermisCreateChercheurComponent implements OnInit {
