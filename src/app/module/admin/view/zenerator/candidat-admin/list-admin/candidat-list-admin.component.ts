...
@Component({
  selector: 'app-candidat-list-admin',
  templateUrl: './candidat-list-admin.component.html',
  styleUrls: ['./candidat-list-admin.component.css']
})
export class CandidatListAdminComponent implements OnInit {
   // declarations
