...
@Component({
    selector: 'app-planning-item-list-admin',
    templateUrl: './planning-item-list-admin.component.html',
    styleUrls: ['./planning-item-list-admin.component.css']
})
export class PlanningItemListAdminComponent implements OnInit {
    // declarations
