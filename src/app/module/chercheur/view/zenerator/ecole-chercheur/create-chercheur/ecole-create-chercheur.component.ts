...
@Component({
    selector: 'app-ecole-create-chercheur',
    templateUrl: './ecole-create-chercheur.component.html',
    styleUrls: ['./ecole-create-chercheur.component.css']
})
export class EcoleCreateChercheurComponent implements OnInit {
