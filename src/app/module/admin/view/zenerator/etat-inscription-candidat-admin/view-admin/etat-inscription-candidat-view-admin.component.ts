...
@Component({
  selector: 'app-etat-inscription-candidat-view-admin',
  templateUrl: './etat-inscription-candidat-view-admin.component.html',
  styleUrls: ['./etat-inscription-candidat-view-admin.component.css']
})
export class EtatInscriptionCandidatViewAdminComponent implements OnInit {
