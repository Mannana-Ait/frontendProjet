...
@Component({
    selector: 'app-avis-visiteur-edit-chercheur',
    templateUrl: './avis-visiteur-edit-chercheur.component.html',
    styleUrls: ['./avis-visiteur-edit-chercheur.component.css']
})
export class AvisVisiteurEditChercheurComponent implements OnInit {
