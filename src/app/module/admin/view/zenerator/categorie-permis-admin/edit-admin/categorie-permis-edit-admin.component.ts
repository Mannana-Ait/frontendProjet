...
@Component({
    selector: 'app-categorie-permis-edit-admin',
    templateUrl: './categorie-permis-edit-admin.component.html',
    styleUrls: ['./categorie-permis-edit-admin.component.css']
})
export class CategoriePermisEditAdminComponent implements OnInit {
