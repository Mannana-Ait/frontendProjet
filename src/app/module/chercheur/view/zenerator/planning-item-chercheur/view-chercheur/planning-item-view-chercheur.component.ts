...
@Component({
    selector: 'app-planning-item-view-chercheur',
    templateUrl: './planning-item-view-chercheur.component.html',
    styleUrls: ['./planning-item-view-chercheur.component.css']
})
export class PlanningItemViewChercheurComponent implements OnInit {
