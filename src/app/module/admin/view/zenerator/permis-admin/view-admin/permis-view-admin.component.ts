...
@Component({
    selector: 'app-permis-view-admin',
    templateUrl: './permis-view-admin.component.html',
    styleUrls: ['./permis-view-admin.component.css']
})
export class PermisViewAdminComponent implements OnInit {
