...
@Component({
    selector: 'app-message-create-chercheur',
    templateUrl: './message-create-chercheur.component.html',
    styleUrls: ['./message-create-chercheur.component.css']
})
export class MessageCreateChercheurComponent implements OnInit {
