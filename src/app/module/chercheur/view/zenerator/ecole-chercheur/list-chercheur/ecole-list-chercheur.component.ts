...
@Component({
    selector: 'app-ecole-list-chercheur',
    templateUrl: './ecole-list-chercheur.component.html',
    styleUrls: ['./ecole-list-chercheur.component.css']
})
export class EcoleListChercheurComponent implements OnInit {
    // declarations
