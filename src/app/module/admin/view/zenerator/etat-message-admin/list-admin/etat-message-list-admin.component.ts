...
@Component({
    selector: 'app-etat-message-list-admin',
    templateUrl: './etat-message-list-admin.component.html',
    styleUrls: ['./etat-message-list-admin.component.css']
})
export class EtatMessageListAdminComponent implements OnInit {
    // declarations
