...
@Component({
    selector: 'app-moniteur-pratique-list-admin',
    templateUrl: './moniteur-pratique-list-admin.component.html',
    styleUrls: ['./moniteur-pratique-list-admin.component.css']
})
export class MoniteurPratiqueListAdminComponent implements OnInit {
    // declarations
