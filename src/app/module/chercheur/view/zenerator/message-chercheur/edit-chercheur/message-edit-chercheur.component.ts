...
@Component({
    selector: 'app-message-edit-chercheur',
    templateUrl: './message-edit-chercheur.component.html',
    styleUrls: ['./message-edit-chercheur.component.css']
})
export class MessageEditChercheurComponent implements OnInit {
