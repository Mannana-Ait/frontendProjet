...
@Component({
    selector: 'app-moniteur-theorique-edit-chercheur',
    templateUrl: './moniteur-theorique-edit-chercheur.component.html',
    styleUrls: ['./moniteur-theorique-edit-chercheur.component.css']
})
export class MoniteurTheoriqueEditChercheurComponent implements OnInit {
