...
@Component({
    ...
    styleUrls: ['./message-view-admin.component.css']
})
export class MessageViewAdminComponent implements OnInit {


    constructor(private datePipe: DatePipe, private roleService: RoleService, private messagesService: MessagesService,
                private router: Router, private etatMessageService: EtatMessageService) {
    }
