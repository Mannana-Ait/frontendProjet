...
@Component({
    selector: 'app-moniteur-theorique-view-chercheur',
    templateUrl: './moniteur-theorique-view-chercheur.component.html',
    styleUrls: ['./moniteur-theorique-view-chercheur.component.css']
})
export class MoniteurTheoriqueViewChercheurComponent implements OnInit {
