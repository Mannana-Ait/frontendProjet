...
@Component({
    selector: 'app-moniteur-pratique-edit-chercheur',
    templateUrl: './moniteur-pratique-edit-chercheur.component.html',
    styleUrls: ['./moniteur-pratique-edit-chercheur.component.css']
})
export class MoniteurPratiqueEditChercheurComponent implements OnInit {
