...
@Component({
    selector: 'app-type-avis-view-chercheur',
    templateUrl: './type-avis-view-chercheur.component.html',
    styleUrls: ['./type-avis-view-chercheur.component.css']
})
export class TypeAvisViewChercheurComponent implements OnInit {
