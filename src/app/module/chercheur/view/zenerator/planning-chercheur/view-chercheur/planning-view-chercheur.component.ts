...
@Component({
  selector: 'app-planning-view-chercheur',
  templateUrl: './planning-view-chercheur.component.html',
  styleUrls: ['./planning-view-chercheur.component.css']
})
export class PlanningViewChercheurComponent implements OnInit {
