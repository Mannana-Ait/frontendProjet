...
@Component({
  selector: 'app-planning-list-chercheur',
  templateUrl: './planning-list-chercheur.component.html',
  styleUrls: ['./planning-list-chercheur.component.css']
})
export class PlanningListChercheurComponent implements OnInit {
   // declarations
