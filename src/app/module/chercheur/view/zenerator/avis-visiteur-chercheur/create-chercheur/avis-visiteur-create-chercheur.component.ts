...
@Component({
    selector: 'app-avis-visiteur-create-chercheur',
    templateUrl: './avis-visiteur-create-chercheur.component.html',
    styleUrls: ['./avis-visiteur-create-chercheur.component.css']
})
export class AvisVisiteurCreateChercheurComponent implements OnInit {
