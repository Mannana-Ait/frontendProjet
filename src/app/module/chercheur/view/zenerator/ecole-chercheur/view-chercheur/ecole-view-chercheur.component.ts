...
@Component({
    selector: 'app-ecole-view-chercheur',
    templateUrl: './ecole-view-chercheur.component.html',
    styleUrls: ['./ecole-view-chercheur.component.css']
})
export class EcoleViewChercheurComponent implements OnInit {
