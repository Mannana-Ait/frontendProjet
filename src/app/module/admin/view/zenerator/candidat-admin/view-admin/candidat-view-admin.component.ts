...
@Component({
  selector: 'app-candidat-view-admin',
  templateUrl: './candidat-view-admin.component.html',
  styleUrls: ['./candidat-view-admin.component.css']
})
export class CandidatViewAdminComponent implements OnInit {
