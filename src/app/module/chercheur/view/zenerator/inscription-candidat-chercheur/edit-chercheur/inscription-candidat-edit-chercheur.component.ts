...
@Component({
  selector: 'app-inscription-candidat-edit-chercheur',
  templateUrl: './inscription-candidat-edit-chercheur.component.html',
  styleUrls: ['./inscription-candidat-edit-chercheur.component.css']
})
export class InscriptionCandidatEditChercheurComponent implements OnInit {
