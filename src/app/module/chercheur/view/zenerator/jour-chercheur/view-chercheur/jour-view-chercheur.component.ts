...
@Component({
    selector: 'app-jour-view-chercheur',
    templateUrl: './jour-view-chercheur.component.html',
    styleUrls: ['./jour-view-chercheur.component.css']
})
export class JourViewChercheurComponent implements OnInit {
