...
@Component({
    selector: 'app-categorie-permis-view-admin',
    templateUrl: './categorie-permis-view-admin.component.html',
    styleUrls: ['./categorie-permis-view-admin.component.css']
})
export class CategoriePermisViewAdminComponent implements OnInit {
