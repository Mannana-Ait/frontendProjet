...
@Component({
    selector: 'app-ecole-edit-chercheur',
    templateUrl: './ecole-edit-chercheur.component.html',
    styleUrls: ['./ecole-edit-chercheur.component.css']
})
export class EcoleEditChercheurComponent implements OnInit {
