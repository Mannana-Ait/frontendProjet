...
@Component({
  selector: 'app-etat-inscription-candidat-edit-chercheur',
  templateUrl: './etat-inscription-candidat-edit-chercheur.component.html',
  styleUrls: ['./etat-inscription-candidat-edit-chercheur.component.css']
})
export class EtatInscriptionCandidatEditChercheurComponent implements OnInit {
