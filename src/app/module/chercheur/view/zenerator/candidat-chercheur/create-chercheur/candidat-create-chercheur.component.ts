...
@Component({
  selector: 'app-candidat-create-chercheur',
  templateUrl: './candidat-create-chercheur.component.html',
  styleUrls: ['./candidat-create-chercheur.component.css']
})
export class CandidatCreateChercheurComponent implements OnInit {
