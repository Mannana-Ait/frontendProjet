...
@Component({
  selector: 'app-etat-inscription-candidat-list-chercheur',
  templateUrl: './etat-inscription-candidat-list-chercheur.component.html',
  styleUrls: ['./etat-inscription-candidat-list-chercheur.component.css']
})
export class EtatInscriptionCandidatListChercheurComponent implements OnInit {
   // declarations
