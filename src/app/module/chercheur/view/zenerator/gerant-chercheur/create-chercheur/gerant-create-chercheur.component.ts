...
@Component({
    selector: 'app-gerant-create-chercheur',
    templateUrl: './gerant-create-chercheur.component.html',
    styleUrls: ['./gerant-create-chercheur.component.css']
})
export class GerantCreateChercheurComponent implements OnInit {
