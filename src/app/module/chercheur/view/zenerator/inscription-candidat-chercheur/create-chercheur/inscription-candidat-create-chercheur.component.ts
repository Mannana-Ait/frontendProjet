...
@Component({
  selector: 'app-inscription-candidat-create-chercheur',
  templateUrl: './inscription-candidat-create-chercheur.component.html',
  styleUrls: ['./inscription-candidat-create-chercheur.component.css']
})
export class InscriptionCandidatCreateChercheurComponent implements OnInit {
