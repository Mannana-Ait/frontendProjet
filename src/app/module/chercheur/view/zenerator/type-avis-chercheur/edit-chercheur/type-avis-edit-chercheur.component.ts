...
@Component({
    selector: 'app-type-avis-edit-chercheur',
    templateUrl: './type-avis-edit-chercheur.component.html',
    styleUrls: ['./type-avis-edit-chercheur.component.css']
})
export class TypeAvisEditChercheurComponent implements OnInit {
